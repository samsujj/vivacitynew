...
echo "<h2>Share Asset Manager :: ". $share_link_name." </h2>";
echo '<p>&nbsp;</p><!--spacer-->';
...
for ( $table_i = 0; $table_i < $this->_pgSize && $table_row; $table_i++ )
{
	...
	if (true) {
		...
		$this->draw_value_field('height', $table_row['height'], $this->db[$this->_keyFieldName], 'table');
		echo "</td>";
		echo "<td align='center'>";
		$this->draw_value_field('width', $table_row['width'], $this->db[$this->_keyFieldName], 'table');
		echo "</td>";
		echo "<td align='center'>";
