...
<div class="container-fluid homeblock8">
    <div class="row">
        <div class="homeblock8header">
            <h1>Subscribe now</h1>
            <span class="footertitlebottomline text-center"></span>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center homeblock8content">
            <h4>Receive Exclusive Offers Delivered To Your Inbox.</h4>
            <div class="homeblock8contentinput">
                <input id="news" type="text" placeholder="Enter your email to join our newsletter">
            </div>
            <a href="javascript:void(0)" onclick="savenews()" class="btn btn-default btngreen">Subscribe</a>
        </div>
    </div>
</div>
...
<!--<div class="container-fluid homeblock9">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center homeblock9content">
            <ul class="list-inline text-center">
                <li>FOLLOW US ON</li>
                <li><a href="javascript:void(0)"><img src="system/themes/vivacity_frontend/images/icon-s1.png"></a></li>
                <li><a href="javascript:void(0)"><img src="system/themes/vivacity_frontend/images/icon-s2.png"></a></li>
                <li><a href="javascript:void(0)"><img src="system/themes/vivacity_frontend/images/icon-s3.png"></a></li>
                <li><a href="javascript:void(0)"><img src="system/themes/vivacity_frontend/images/icon-s4.png"></a></li>
                <li><a href="javascript:void(0)"><img src="system/themes/vivacity_frontend/images/icon-s5.png"></a></li>
            </ul>
        </div>
    </div>
</div>-->
...
<div class="container-fluid homeblock10">
    <div class="row">
        <div class="container-fluid homeblock10contentwrapper">
            <div class="row">
                <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 text-center homeblock10contentleft">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 text-center homeblock10contentright">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 text-center homeblock10menuleft">
                            <ul class="text-left">
                                <h2>MY ACCOUNT</h2>
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 text-center homeblock10menuright">
                            <ul class="text-left">
                                <h2>CONTACT US</h2>
...
<div class="container-fluid homeblock11">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center homeblock11content">
            <ul class="list-inline text-center">
                <li> <a href="javascript:void(0)" data-toggle="modal" data-target="#myModalPolicyproceduresf">Policies and Procedures</a></li>
...
<div id="myModalnews" class="modal fade footermodel" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header hide">
                <button type="button" class="close" data-dismiss="modal">×</button>
                <h4 class="modal-title hide">THANK YOU</h4>
            </div>
            <div class="modal-body">
                <div class="classdiv1_new" style="margin:0 auto">
                    <img style="max-height:100px;max-widthy:100px;margin-left:7%" src="system/themes/vivacity_frontend/images/logo-vivacity.png"><br/>
                    <h2 style="text-align:center;margin-top:30px;" >Thank You For Subscribing!</h2>
...
<div id="myModalnewsinvalid" class="modal fade footermodel" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header hide">
            ...
            <div class="modal-body">
                <div class="classdiv1_new">
                    ...
                    <img style="max-height:100px;max-widthy:100px;margin-left:7%" src="system/themes/vivacity_frontend/images/logo-vivacity.png"><br/>
                    <h2 style="text-align:center;margin-top:30px;" >Invalid Email Address!</h2>
...
<div class="hide userid"><?php echo strtolower($AI->user->username); ?></div>

<div class="modal fade footermenumodal" id="myModalPolicyproceduresf" role="dialog">
...
<div id="myModaltermsf" class="modal fade footermenumodal" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
...
<div id="myModalrefundandreturnsf" class="modal fade footermenumodal " role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
...
<div id="myModalPrivacyPolicyf" class="modal fade footermenumodal" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
