...
<div class="opportunity_blockwrapper">
    <div class="container-fluid toplogoblock text-center">
        <img class="img-responsive" src="system/themes/vivacity_frontend/images/logo-vivacity.png">
    </div>
    ...
    <div class="container-fluid toptitleblock">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h2 class="titlebar">
                    <span class="hide">Vivacity is set to hit the world stage with an incredible launch in 2017!</span>
                </h2>
            </div>
        </div>
    </div>
